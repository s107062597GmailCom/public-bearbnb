...
public class EditRoomDto {
    ...
    public EditRoomDto(Room room) {
        ...
        this.title = room.getInformation().getTitle();
        this.bathroomCount = room.getInformation().getBathroomCount();
        this.bedroomCount = room.getInformation().getBedroomCount();
        this.price =room.getPrice();
        this.singleSizeBedCount = room.getInformation().getSingleSizeBedCount();
        this.doubleSizeBedCount = room.getInformation().getDoubleSizeBedCount();
        this.floorMattressCount =room.getInformation().getFloorMattressCount();
        this.status = room.getStatus().getId();
        this.statusTitle = room.getStatus().getTitle();
        this.type = room.getInformation().getType().getId();
        this.typeTitle = room.getInformation().getType().getTitle();
        this.cityTitle =room.getCity().getTitle();
        this.city =room.getCity().getId();
        this.fronCoverUuid = room.getFrontCoverPhoto().getUuid();
    }
