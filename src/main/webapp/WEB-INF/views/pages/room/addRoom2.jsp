					...
					<li id="page1">
						<fieldset class="divblock">
							<div id="title_div">
								...
								<button type="button" class="insert" id="autoinsert1"></button>
							</div>
							<div id="form_div">
								...
								<div id="subform">
									...
									<div class="st1">
										...
										<button type="button" id="search" class="search"
											data-toggle="modal" data-target="#myModal">確認地址</button><span id="address_error" class="alarm"></span>
					...
					<li id="page3">
						<fieldset>
							<div id="title_div">
								...
								<button type="button" class="insert" id="autoinsert2"></button>
							</div>
							<div id="form_div">
								<div id="subform">
									<div class="st1">
					...
					<li id="page5">
						...
						<fieldset>
							<div id="title_div">
								...
								<button type="button" class="insert" id="autoinsert3"></button>
							</div>
							<div id="form_div">
								<div id="subform">
									<div class="st1">
